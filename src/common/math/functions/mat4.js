...
export function lookAt(position, target, up, dest) {
  ...
  // 参考：　https://webglfundamentals.org/webgl/lessons/ja/webgl-3d-camera.html
  // 1.まずは注視先から物体（カメラ等）へ向かうベクトルzを算出して正規化。
  ...
  // 2. 目標へのベクトルと真上のベクトルを外戚することによって物体のx軸のベクトルを算出。
  x0 = upY * z2 - upZ * z1
  x1 = upZ * z0 - upX * z2
  x2 = upX * z1 - upY * z0
  ...
  //   y0, y1, y2, 0, //y軸
  //   z1, z2, z3, 0, //z軸
  //   positionX,  positionY,  positionZ, 1 // 物体の位置
  // ];
  // return objectVecMat
